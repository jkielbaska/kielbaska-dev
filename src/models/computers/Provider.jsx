...
import { ScreenText, ScreenInteractive } from "./ScreenTexts";
...
// const context = createContext<Record<GLTFResult, THREE.Mesh | undefined>>(
//   null!
// );
// const context = createContext<GLTFResult["nodes"]>(null!);
...
export const ComputersProvider = ({ scale }) => {
  const instances = useContext(context);
  const { nodes: n, materials: m } = useGLTF(computersScene);
...
useGLTF.preload(computersScene);
...
// }) {
//   const { nodes } = useGLTF(computersScene) as GLTFResult;
//   const instances = useMemo(
//     () => ({
//       Object: nodes.Object_4,
//       Object1: nodes.Object_16,
...
// export const ComputersProvider = ({ scale }: { scale: Vector3 }) => {
//   const instances = useContext(context);
//   const { nodes: n, materials: m } = useGLTF(computersScene) as GLTFResult;
