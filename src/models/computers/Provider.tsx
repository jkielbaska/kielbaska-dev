...
type NodeObject = Record<string, THREE.Mesh>;

//write correct typescript interface for context down below
...
export function Instances({
  ...
  const instances = useMemo<NodeObject>(
    () => ({
